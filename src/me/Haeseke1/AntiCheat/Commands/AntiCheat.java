...
public class AntiCheat implements CommandExecutor{
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		...
		if(args.length == 0){
			player.sendMessage(ChatColor.translateAlternateColorCodes('&', "&c =*= &6A&8n&6t&8i&6C&8h&6e&8a&6t&c =*= "));
			MessageManager.sendMessage("&6/anticheat toggle [mode] [true/false] &e#Change the config settings", player);
			MessageManager.sendMessage("&6/anticheat commands add [command] &e#Add commands to the block list", player);
		    return false;
		}
